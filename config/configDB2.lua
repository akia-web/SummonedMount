...
local options = {
    ...
    args = {
        ...
        mount1 = {
            ...
            type = "description",
            name = function()
                return core.ConfigDB:getMount1()
            end,
            cmdHidden = true
        },
        searchMount1 = {
            ...
            func = function()
                core.ConfigDB:openPopupListMount(core.L['Monture'] .. ' 1')
            end,
        },
        ghostDescription3 = {
            order = 7,
        ...
        mount2 = {
            ...
            type = "description",
            name = function()
                return core.ConfigDB:getMount2()
            end,
            cmdHidden = true
        },
        searchMount2 = {
            ...
            func = function()
                core.ConfigDB:openPopupListMount(core.L['Monture'] .. ' 2')
            end,
        },
...
function SummonedMount:OnInitialize()
    ...
    core.selectedOptionMount = self.db.profile.selectOption
    core.buttonPosition = self.db.profile.buttonPosition
    core.iconeSize = self.db.profile.iconeSize
